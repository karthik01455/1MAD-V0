...
export default function KeyDecisionsHeader(props) {
  ...
  return (
    ...
    }} ><Typography style={{ fontFamily: 'Roboto', fontSize: '18px', lineHeight: '20px' }} sx={{ color: "#FFFFFF", paddingRight: '5px' }}>KEY DECISOINS ({countOfItems})</Typography> <Model heading={heading} definition={definition} accessibiltyInformation={accessibiltyInformation} /> </Box>
  )
}
